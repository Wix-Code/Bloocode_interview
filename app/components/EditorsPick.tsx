  ...
  return (
    <div className='bg-[#F6F6F6] pb-5 mt-8'>
      <div className='max-w-[1200px] max-sm:mx-5 mx-auto flex flex-col gap-2'>
        ...
        <div className='flex h-[550px] items-center gap-8 mt-5'>
          <div className='w-[50%] relative h-full'>
            ...
            <div className='absolute flex gap-4 px-5 py-2 bottom-0 items-center bg-[#000000c9]'>
              ...
              <p className='text-[24px] text-[#FFFFFF] cursor-pointer font-[800]'>Bridging the Financing Gap in Nigeria’s off-grid sector</p>
            </div>
          </div>
          <div className='h-full flex flex-col gap-1 w-[50%]'>
            <div className='flex max-sm:flex-col gap-9 h-[450px]'>
              <div className='bg-[#FFFFFF] w-full flex flex-col gap-4'>
                <img className='object-cover h-[250px] w-full' src="/files/epi.png" alt="" />
                <div className='flex items-center relative gap-1  mx-10'>
                  ...
                  <h1 className='text-[18px] font-[600] text-[#282828]'>The Future of Work: Embracing Remote and Hybrid Workforces</h1>
                </div>
                <p className='text-[13px] ml-11 font-normal text-left mb-5 text-[#282828]'>Aug 7, 2025</p>
              </div>
              <div className='bg-[#FFFFFF] w-full flex flex-col gap-4'>
                <img className='object-cover h-[250px] w-full' src="/files/ad.png" alt="" />
                <div className='flex items-center relative gap-1  mx-10'>
                  <div>
                    <img className='absolute w-[40px] h-[40px] rounded-[50%] object-cover left-[-59px] top-0' src="/files/u.png" alt="" />
                  </div>
                  <h1 className='text-[18px] font-[600] text-[#282828]'>Compatibility in Relationship</h1>
                </div>
                <p className='text-[13px] ml-11 font-normal text-left mb-5 text-[#282828]'>Aug 7, 2025</p>
              </div>
            </div>
