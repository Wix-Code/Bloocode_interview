    ...
    <div className='mt-10'>
      <div className='max-w-[1200px] mx-auto'>
        <div className='flex items-center  max-sm:text-[16px] justify-between mb-5 max-sm:mx-0 mx-10'>
          <h1 className='text-[#5A5A5A] max-xl:mx-5 font-[700] max-sm:text-[14px] text-[20px] border-l-[3px] border-[#CC0001] pl-1'>News & Storytelling</h1>
...
export default NewsStoryTelling