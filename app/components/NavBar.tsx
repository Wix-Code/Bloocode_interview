  ...
  return (
    <div className='bg-[#FFFFFF] sticky z-50 top-0'>
      <div className='max-w-[1200px] max-sm:relative mx-auto flex items-center h-[80px] justify-between py-5'>
        <img className='w-[150px] max-sm:w-[90px] object-cover ml-5' src="/files/afr.png" alt="" />
        ...
        <button onClick={() => setOpenNav(!openNav)} className='max-sm:flex text-[18px] hidden mr-5'><FaBars /></button>
      </div>
