...
const Banner = () => {
  return (
    <div className='bg-[#F6E8E8] py-10 mt-10 z-10'>
      <div className='max-w-[1100px] mx-auto flex justify-between max-sm:gap-5 max-sm:mx-5 max-sm:flex-col items-center'>
        <div className='flex flex-col gap-3 max-sm:gap-2 flex-1'>
          <h1 className='text-[32px]  max-sm:text-[26px] font-[800] text-[#282828]'>Never stop listening!</h1>
          <p className='text-[#282828] max-sm:text-[18px] text-[24px] font-[500] leading-7'>Every episodes is a journey <br /> you don’t wanna miss out on. </p>
          ...
          <div className='flex w-[100%] bg-[#FFFFFF] h-[49px] gap-[2px] items-center'>
            ...
            <button className='bg-[#CC0001] max-sm:text-[13px] rounded-[3px] cursor-pointer h-[100%] w-[25%] text-[#FFFFFF] text-[16px] font-[700]'>Get me in</button>
          </div>
        </div>
